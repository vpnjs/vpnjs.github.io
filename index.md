...
如果你常用的VPN软件暂时无法使用，而你又急需<a href="https://vpnjs.github.io/">翻墙</a>，这时候备用VPN就能派上用场了。我一直建议大家至少准备两个不同品牌的VPN，就是为了应对这种情况。有时候某个VPN软件的服务器集体被封锁，但另一个VPN软件可能还可以正常使用。如果你没有备用VPN，可以考虑购买一个，现在大部分VPN都有30天退款保证，可以先用来应急，等主力VPN恢复后再决定是否继续使用。
